...
command! -nargs=1 -complete=custom,simple_bookmarks#BookmarkNames Bookmarkdel call simple_bookmarks#Del(<f-args>)
command! -nargs=1 -complete=custom,simple_bookmarks#BookmarkNames Bookmarkgo call simple_bookmarks#Go(<f-args>)
command! Bookmarklist call simple_bookmarks#Copen()
